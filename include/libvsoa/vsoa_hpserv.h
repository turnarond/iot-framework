 ...
 *
 * File: vsoa_hpserv.h Vehicle SOA high performance server.
 *
...
/* VSOA server parallel */
#define VSOA_SERVER_DEF_PARALLEL  4
#define VSOA_SERVER_MAX_PARALLEL  8

/* VSOA server packet buffer */
#define VSOA_SERVER_DEF_PBUF_SIZE  (  4 * 1024 * 1024)
#define VSOA_SERVER_MAX_PBUF_SIZE  (128 * 1024 * 1024)
...
/* Create VSOA server
 * used default parallel parameter 
...
/* Create VSOA server with extended parameter
 * Warning: This function must be mutually exclusive with the vsoa_server_close() call */
vsoa_server_t *vsoa_server_create_ex(const char *info_json, int parallel, size_t pbuf_sz);
