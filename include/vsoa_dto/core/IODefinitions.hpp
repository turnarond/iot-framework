...
#ifndef vsoa_IODefinitions_hpp
#define vsoa_IODefinitions_hpp

#include "vsoa_dto/core/Types.hpp"
#include "vsoa_dto/core/async/Error.hpp"
...
enum IOError : v_io_size {
  ...
  /**
   * In vsoa 0 is considered to be an Error as for I/O operation size. <br>
   *
 ...
 * Extends &id:vsoa::async::Error;.
 */
class AsyncIOError : public vsoa::async::Error {
private:
  v_io_size m_code;
public:
