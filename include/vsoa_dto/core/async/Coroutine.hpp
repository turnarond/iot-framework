...
#ifndef vsoa_async_Coroutine_hpp
#define vsoa_async_Coroutine_hpp

#include "./Error.hpp"

#include "vsoa_dto/core/async/utils/FastQueue.hpp"
...
public:
   ...
   * @param ioHandle - &id:vsoa::v_io_handle;.
   * @return - Action.
   */
   ...
   * @param error - pointer to &id:vsoa::async::Error;.
   */
  Action(Error* error);
   ...
   * @return - &id:vsoa::v_io_handle;.
   */
  vsoa::v_io_handle getIOHandle() const;
 ...
 */
class AbstractCoroutine : public vsoa::base::Countable {
  friend CoroutineStarter;
  friend CoroutineHandle;
public:
  /**
...
public:
   ...
   * @param error - &id:vsoa::async::Error;.
   ...
   * @return - error reporting &id:vsoa::async::Action;.
   */
 ...
 * Example usage:<br>
 * `class MyCoroutine : public vsoa::async::Coroutine<MyCoroutine>`
...
public:
  ...
  public:
     ...
     * @return - &id:vsoa::async::Action;.
     */
    template<typename C>
    Action callbackTo(Action (C::*callback)(Args...)) {
      if(m_coroutine == nullptr) {
        throw std::runtime_error("[vsoa::async::AbstractCoroutineWithResult::StarterForResult::callbackTo()]: Error. Coroutine is null.");
      }
 ...
 * Example usage:<br>
 * `class CoroutineWithResult : public vsoa::async::CoroutineWithResult<CoroutineWithResult, const char*>`
 * @tparam T - child class type.
...
#endif /* vsoa_async_Coroutine_hpp */
