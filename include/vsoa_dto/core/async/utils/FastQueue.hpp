...
#ifndef vsoa_async_utils_FastQueue_hpp
#define vsoa_async_utils_FastQueue_hpp

#include "vsoa_dto/core/concurrency/SpinLock.hpp"
#include "vsoa_dto/core/base/Environment.hpp"

namespace vsoa { namespace async { namespace utils {
...
#endif /* vsoa_async_utils_FastQueue_hpp */
