...
#ifndef vsoa_data_mapping_type_Any_hpp
#define vsoa_data_mapping_type_Any_hpp
...
/**
 * Any - ObjectWrapper to hold Any vsoa mapping-enabled type.
 */
...
public:
   ...
   * @tparam T
   * @tparam C
   * @param polymorph - ObjectWrapper. Ex.: `vsoa::String`, `vsoa::List<...>`, etc.
   */
  template<class T, class C>
...
#endif //vsoa_data_mapping_type_Any_hpp
