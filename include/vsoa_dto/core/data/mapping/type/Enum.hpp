...
#ifndef vsoa_data_mapping_type_Enum_hpp
#define vsoa_data_mapping_type_Enum_hpp

#include "./Any.hpp"
#include "./Primitive.hpp"
#include "vsoa_dto/core/data/share/MemoryLabel.hpp"
...
enum class EnumInterpreterError : v_int32 {
   ...
   * `vsoa::Enum<T>` is passed to interpreter of `vsoa::Enum<T>::NotNull`.
   */
  TYPE_MISMATCH_ENUM = 1,

  /**
   * Wrong &id:vsoa::data::mapping::type::Primitive; is passed to interpreter.
   */
...
struct EnumValueInfo {
   ...
   * &id:vsoa::data::share::StringKeyLabel;.
   */
...
/**
 * Template class for `vsoa::Enum<T>`.
 * @tparam T - enum type.
...
public:
  ...
  static const EnumValueInfo<T>& getEntryByName(const String& name) {
    ...
    throw std::runtime_error("[vsoa::data::mapping::type::Enum::getEntryByName()]: Error. Entry not found.");
  }
  ...
  static const EnumValueInfo<T>& getEntryByValue(T value) {
    ...
    throw std::runtime_error("[vsoa::data::mapping::type::Enum::getEntryByValue()]: Error. Entry not found.");
  }
  ...
  static const EnumValueInfo<T>& getEntryByUnderlyingValue(UnderlyingEnumType value) {
    ...
    throw std::runtime_error("[vsoa::data::mapping::type::Enum::getEntryByUnderlyingValue()]: Error. Entry not found.");
  }
  ...
  static const EnumValueInfo<T>& getEntryByIndex(v_int32 index) {
    ...
    throw std::runtime_error("[vsoa::data::mapping::type::Enum::getEntryByIndex()]: Error. Entry not found.");
  }
      ...
      std::vector<type::Any> getInterpretedEnum() const override {
        ...
        for(const auto& e : EnumOW::getEntries()) {
          ...
          if(error != type::EnumInterpreterError::OK) {
            throw std::runtime_error("[vsoa::data::mapping::type::__class::Enum<T, Interpreter>::getInterpretedEnum()]: Unknown error.");
          }
        }
...
namespace std {
  ...
  struct hash <vsoa::data::mapping::type::EnumObjectWrapper<T, I>> {

    typedef vsoa::data::mapping::type::EnumObjectWrapper<T, I> argument_type;
...
#endif // vsoa_data_mapping_type_Enum_hpp
