...
#ifndef vsoa_data_type_Object_hpp
#define vsoa_data_type_Object_hpp
...
/**
 * Base class of all object-like mapping-enabled structures ex.: vsoa::DTO.
 */
class BaseObject : public vsoa::base::Countable {
public:
  ...
  public:
     ...
     * @return reference to std::unordered_map of std::string to &id:vsoa::data::mapping::type::BaseObject::Property;*.
     */
     ...
     * @return std::list of &id:vsoa::data::mapping::type::BaseObject::Property;*.
     */
...
namespace __class {
  ...
  public:
     ...
     * @return - &id:vsoa::data::mapping::type::Type;
     */
    static Type* getType() {
...
/**
 * ObjectWrapper for &l:DTO;. AKA `vsoa::Object<T>`.
...
public:
  ...
  VSOA_DEFINE_OBJECT_WRAPPER_DEFAULTS(DTOWrapper, TemplateObjectType, TemplateObjectClass)
...
public:
  ...
  using Fields = vsoa::data::mapping::type::PairList<String, Value>;

  template <class Value>
  using UnorderedFields = vsoa::data::mapping::type::UnorderedMap<String, Value>;
...
namespace std {
  ...
  template<class T>
  struct hash<vsoa::data::mapping::type::DTOWrapper<T>> {

    typedef vsoa::data::mapping::type::DTOWrapper<T> argument_type;
...
#endif /* vsoa_data_type_Object_hpp */
