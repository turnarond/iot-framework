...
#ifndef vsoa_data_type_Primitive_hpp
#define vsoa_data_type_Primitive_hpp
...
namespace vsoa { namespace data { namespace mapping { namespace type {
...
public:
  ...
  /**
   * Load data from file and store in &id:vsoa::String;.
   * @param filename - name of the file.
   * @return - &id:vsoa::String;.
   */
  ...
  operator std::string() const {
    if (this->m_ptr == nullptr) {
      throw std::runtime_error("[vsoa::data::mapping::type::String::operator std::string() const]: "
                               "Error. Null pointer.");
    }
...
public:
  ...
  VSOA_DEFINE_OBJECT_WRAPPER_DEFAULTS(Primitive, TValueType, Clazz)
...
public:
  ...
  VSOA_DEFINE_OBJECT_WRAPPER_DEFAULTS(Boolean, bool, __class::Boolean)
...
namespace std {
  ...
  template<>
  struct hash<vsoa::data::mapping::type::String> {

    typedef vsoa::data::mapping::type::String argument_type;
  ...
  template<>
  struct hash<vsoa::data::mapping::type::Boolean> {

    typedef vsoa::data::mapping::type::Boolean argument_type;
    typedef v_uint64 result_type;
  ...
  template<>
  struct hash<vsoa::data::mapping::type::Int8> {

    typedef vsoa::data::mapping::type::Int8 argument_type;
    typedef v_uint64 result_type;
  ...
  template<>
  struct hash<vsoa::data::mapping::type::UInt8> {

    typedef vsoa::data::mapping::type::UInt8 argument_type;
    typedef v_uint64 result_type;
  ...
  template<>
  struct hash<vsoa::data::mapping::type::Int16> {

    typedef vsoa::data::mapping::type::Int16 argument_type;
    typedef v_uint64 result_type;
  ...
  template<>
  struct hash<vsoa::data::mapping::type::UInt16> {

    typedef vsoa::data::mapping::type::UInt16 argument_type;
    typedef v_uint64 result_type;
  ...
  template<>
  struct hash<vsoa::data::mapping::type::Int32> {

    typedef vsoa::data::mapping::type::Int32 argument_type;
    typedef v_uint64 result_type;
  ...
  template<>
  struct hash<vsoa::data::mapping::type::UInt32> {

    typedef vsoa::data::mapping::type::UInt32 argument_type;
    typedef v_uint64 result_type;
  ...
  template<>
  struct hash<vsoa::data::mapping::type::Int64> {

    typedef vsoa::data::mapping::type::Int64 argument_type;
    typedef v_uint64 result_type;
  ...
  template<>
  struct hash<vsoa::data::mapping::type::UInt64> {

    typedef vsoa::data::mapping::type::UInt64 argument_type;
    typedef v_uint64 result_type;
  ...
  template<>
  struct hash<vsoa::data::mapping::type::Float32> {

    typedef vsoa::data::mapping::type::Float32 argument_type;
    typedef v_uint64 result_type;
  ...
  template<>
  struct hash<vsoa::data::mapping::type::Float64> {

    typedef vsoa::data::mapping::type::Float64 argument_type;
    typedef v_uint64 result_type;
...
#endif /* vsoa_base_Countable_PrimitiveDataTypes_hpp */
