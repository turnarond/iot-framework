...
#ifndef vsoa_data_share_LazyStringMap_hpp
#define vsoa_data_share_LazyStringMap_hpp

#include "./MemoryLabel.hpp"
#include "vsoa_dto/core/concurrency/SpinLock.hpp"
 ...
 * @tparam Key - one of: &id:vsoa::data::share::MemoryLabel;, &id:vsoa::data::share::StringKeyLabel;, &id:vsoa::data::share::StringKeyLabelCI;,
 * &id:vsoa::data::share::StringKeyLabelCI;.
 */
...
public:
   ...
   * @tparam T - one of: &id:vsoa::data::share::MemoryLabel;, &id:vsoa::data::share::StringKeyLabel;, &id:vsoa::data::share::StringKeyLabelCI;.
   * @param key
   * @return
   */
  template<class T>
...
#endif //vsoa_data_share_LazyStringMap_hpp
