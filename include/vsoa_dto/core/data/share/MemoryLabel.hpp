...
#ifndef vsoa_data_share_MemoryLabel_hpp
#define vsoa_data_share_MemoryLabel_hpp

#include "vsoa_dto/core/data/mapping/type/Primitive.hpp"
#include "vsoa_dto/core/utils/String.hpp"

#include <cstring>
#include <memory>

namespace vsoa { namespace data { namespace share {
...
public:
   ...
   * Data is compared using &id:vsoa::urils::String::compare;.
  ...
  /**
   * Create vsoa::String from memory label
   * @return vsoa::String(data, size)
   */
...
namespace std {
  ...
  template<>
  struct hash<vsoa::data::share::StringKeyLabel> {
    
    typedef vsoa::data::share::StringKeyLabel argument_type;
    typedef v_uint64 result_type;
    
    result_type operator()(vsoa::data::share::StringKeyLabel const& s) const noexcept {
  ...
  template<>
  struct hash<vsoa::data::share::StringKeyLabelCI> {
    
    typedef vsoa::data::share::StringKeyLabelCI argument_type;
    typedef v_uint64 result_type;
    
    result_type operator()(vsoa::data::share::StringKeyLabelCI const& s) const noexcept {
...
#endif /* vsoa_data_share_MemoryLabel_hpp */
