...
#ifndef vsoa_data_Stream
#define vsoa_data_Stream

#include "vsoa_dto/core/data/share/LazyStringMap.hpp"
#include "vsoa_dto/core/async/Coroutine.hpp"
#include "vsoa_dto/core/data/buffer/IOBuffer.hpp"
#include "vsoa_dto/core/data/buffer/Processor.hpp"

#include "vsoa_dto/core/IODefinitions.hpp"

namespace vsoa { namespace data{ namespace stream {
...
public:
  /**
   * Convenience typedef for &id:vsoa::data::share::LazyStringMap;.
   */
  typedef vsoa::data::share::LazyStringMap<vsoa::data::share::StringKeyLabel> Properties;
private:
...
public:
   ...
   * @return - &id:vsoa::async::CoroutineStarter;.
   */
 ...
 */
class DefaultInitializedContext : public vsoa::data::stream::Context {
private:
...
public:
   ...
   * @param action - async specific action. If action is NOT &id:vsoa::async::Action::TYPE_NONE;, then
   ...
   * @return - actual number of bytes written. &id:vsoa::v_io_size;.
   */
  v_io_size writeSimple(const vsoa::String& str){
...
public:
   ...
   * @param value
   * @return - actual number of bytes written. &id:vsoa::v_io_size;. <br>
   */
...
ConsistentOutputStream& operator << (ConsistentOutputStream& s, const vsoa::String& str);
 ...
 */
class AsyncTransferError : public vsoa::async::Error {
public:
  /**
   * Constructor.
   * @param what
   */
  AsyncTransferError(const char* what) : vsoa::async::Error(what) {}
};
 ...
 * @param writeCallback - &l:WriteCallback;.
 * @param transferSize - how much data should be read from the `readCallback`. `0` - to read until error.
 * @param buffer - &id:vsoa::data::buffer::IOBuffer; used to do the transfer by chunks.
 * @param processor - data processing to be applied during the transfer.
 * @return - &id:vsoa::async::CoroutineStarter;.
 */
