...
#ifndef vsoa_utils_ConversionUtils_hpp
#define vsoa_utils_ConversionUtils_hpp

#include "vsoa_dto/core/data/mapping/type/Primitive.hpp"
...
namespace vsoa { namespace utils { namespace conversion {
  ...
  /**
   * String to 32-bit integer.
   * @param str - string as `vsoa::String`.
   * @param success - out parameter. `true` if operation was successful. `false` otherwise.
   * @return - 32-bit integer value.
   */
  v_int32 strToInt32(const vsoa::String& str, bool& success);
   ...
   * @return - 32-bit unsigned integer value.
   */
  v_uint32 strToUInt32(const vsoa::String& str, bool& success);
   ...
   * @return - 64-bit integer value.
   */
  v_int64 strToInt64(const vsoa::String& str, bool& success);
   ...
   * @return - 64-bit unsigned integer value.
   */
  v_uint64 strToUInt64(const vsoa::String& str, bool& success);
 ...
 v_buff_size int64ToCharSequence(v_int64 value, p_char8 data, v_buff_size n);
   ...
   * Convert 32-bit integer to it's string representation.
   * @param value - 32-bit integer value.
   * @return - value as `vsoa::String`
   */
  vsoa::String int32ToStr(v_int32 value);
   ...
   * @return - value as `vsoa::String`
   */
  vsoa::String uint32ToStr(v_uint32 value);
   ...
   * @return - value as `vsoa::String`
   */
  vsoa::String int64ToStr(v_int64 value);
   ...
   * @return - value as `vsoa::String`
   */
  vsoa::String uint64ToStr(v_uint64 value);
   ...
   */
  template<typename T>
  vsoa::String primitiveToStr(T value, const char* pattern){
    v_char8 buff [100];
    auto size = primitiveToCharSequence(value, &buff[0], 100, pattern);
    if(size > 0){
      return vsoa::String(reinterpret_cast<const char*>(&buff[0]), size);
    }
    return nullptr;
  }
   ...
   * @return - 32-bit float value.
   */
  v_float32 strToFloat32(const vsoa::String& str, bool& success);
   ...
   * @return - 64-bit float value.
   */
  v_float64 strToFloat64(const vsoa::String& str, bool& success);
   ...
   * @return - length of the resultant string.
   */
  v_buff_size float32ToCharSequence(v_float32 value, p_char8 data, v_buff_size n, const char* format = VSOA_FLOAT_STRING_FORMAT);
   ...
   * @return - length of the resultant string.
   */
  v_buff_size float64ToCharSequence(v_float64 value, p_char8 data, v_buff_size n, const char* format = VSOA_FLOAT_STRING_FORMAT);
   ...
   * @return - value as `vsoa::String`
   */
  vsoa::String float32ToStr(v_float32 value, const char* format = VSOA_FLOAT_STRING_FORMAT);
   ...
   * @return - value as `vsoa::String`
   */
  vsoa::String float64ToStr(v_float64 value, const char* format = VSOA_FLOAT_STRING_FORMAT);
   ...
   * @return - value as `vsoa::String`;
   */
  vsoa::String boolToStr(bool value);
   ...
   */
  bool strToBool(const vsoa::String& str, bool& success);
  
}}}

#endif /* vsoa_utils_ConversionUtils_hpp */
