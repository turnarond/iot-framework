...
#ifndef vsoa_encoding_Base64_hpp
#define vsoa_encoding_Base64_hpp

#include "vsoa_dto/core/Types.hpp"

namespace vsoa { namespace encoding {
...
public:
   ...
   * @return - encoded base64 string as &id:vsoa::String;.
   */
  static vsoa::String encode(const void* data, v_buff_size size, const char* alphabet = ALPHABET_BASE64);
   ...
   * @return - encoded base64 string as &id:vsoa::String;.
   */
  static vsoa::String encode(const vsoa::String& data, const char* alphabet = ALPHABET_BASE64);
   ...
   * @param auxiliaryChars - configurable auxiliary chars.
   * @return - decoded data as &id:vsoa::String;.
   * @throws - &l:Base64::DecodingError;
   */
  static vsoa::String decode(const char* data, v_buff_size size, const char* auxiliaryChars = ALPHABET_BASE64_AUXILIARY_CHARS);
   ...
   * @throws - &l:Base64::DecodingError;
   */
  static vsoa::String decode(const vsoa::String& data, const char* auxiliaryChars = ALPHABET_BASE64_AUXILIARY_CHARS);
  
};
  
}}

#endif /* vsoa_encoding_Base64_hpp */
