...
#ifndef vsoa_parser_json_Utils_hpp
#define vsoa_parser_json_Utils_hpp
 ...
 * Used by &id:vsoa::parser::json::mapping::Serializer;, &id:vsoa::parser::json::mapping::Deserializer;.
 */
class Utils {
public:
...
public:
  ...
  typedef vsoa::parser::Caret ParsingCaret;
private:
...
#endif /* vsoa_parser_json_Utils_hpp */
