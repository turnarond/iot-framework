 ...
 * @FilePath: /acoinfo/edge-framework/src/service/server_mgr/src/AppComponent.hpp
 * @Description: Application Component for Server Manager
 * 
...
public:
  ...
  OATPP_CREATE_COMPONENT(std::shared_ptr<vsoa::network::ServerConnectionProvider>, serverConnectionProvider)([] {
    return vsoa::network::tcp::server::ConnectionProvider::createShared(
      {"0.0.0.0", 8082, vsoa::network::Address::IP_4}
    );
  }());
